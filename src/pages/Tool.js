        ...
        <div className="md:w-1/2 px-10">
          ...
          <form className="w-full flex flex-col " onSubmit={e => onAddExperimentalConditionsFilters(e)}>
            <div className="flex justify-center align-middle mb-4">
              ...
              <button className="w-9 h-9 self-center text-center bg-gray-400 hover:bg-blue-700 text-white text-3xl font-bold rounded focus:outline-none focus:shadow-outline"
            ...
            {showExperimentalConditions &&
              <React.Fragment>
                ...
                <FieldInput type="number" label="Tube Diameter" unit="mm" step={defaultPrecision} id="tube-diameter"
                  valueType="TUBE_DIAMETER_CHANGE" ineqType="TUBE_DIAMETER_INEQ_CHANGE" />
                <FieldInput type="number" label="Cross Sectional Area" step={defaultPrecision} unit="mm&sup2;" id="cross-sectional-area"
                  valueType="CROSS_SECTIONAL_AREA_CHANGE" ineqType="CROSS_SECTIONAL_AREA_INEQ_CHANGE" />
                <FieldInput type="number" label="Tube Length" unit="mm" step={defaultPrecision} id="tube-length"
                  valueType="TUBE_LENGTH_CHANGE" ineqType="TUBE_LENGTH_INEQ_CHANGE" />
                <FieldInput type="number" label="Base Pressure" unit="Torr" step={defaultPrecision} id="base-pressure"
                  valueType="BASE_PRESSURE_CHANGE" ineqType="BASE_PRESSURE_INEQ_CHANGE" />
                <FieldInput type="number" label="Thickness" unit="um" step={defaultPrecision} id="thickness"
                  valueType="THICKNESS_CHANGE" ineqType="THICKNESS_INEQ_CHANGE" />
                <FieldInput type="number" label="Diameter" unit="um" step={defaultPrecision} id="diameter"
          ...
          <form className="w-full flex flex-col mt-10" onSubmit={e => onAddPreparationFilters(e)}>
            ...
            {showPreparation &&
              <React.Fragment>
                <FieldInput type="select" options={prepNameOptions} label="Name" id="name"
                  valueType="PREP_NAME_CHANGE" />
                <FieldInput type="number" label="Duration" unit="min" step={defaultPrecision} id="duration"
                  valueType="DURATION_CHANGE" ineqType="DURATION_INEQ_CHANGE" />
                <FieldInput type="number" label="Furnace Temperature" unit="&deg;C" step={defaultPrecision} id="furnace-temperature"
                  valueType="FURNACE_TEMPERATURE_CHANGE" ineqType="FURNACE_TEMPERATURE_INEQ_CHANGE" />
                <FieldInput type="number" label="Furnace Pressure" unit="Torr" step={defaultPrecision} id="furnace-pressure"
                  valueType="FURNACE_PRESSURE_CHANGE" ineqType="FURNACE_PRESSURE_INEQ_CHANGE" />
                <FieldInput type="number" label="Sample Location" unit="mm" step={defaultPrecision} id="sample-location"
                  valueType="SAMPLE_LOCATION_CHANGE" ineqType="SAMPLE_LOCATION_INEQ_CHANGE" />
                <FieldInput type="number" label="Helium Flow Rate" unit="sccm" step={defaultPrecision} id="helium-flow-rate"
                  valueType="HELIUM_FLOW_RATE_CHANGE" ineqType="HELIUM_FLOW_RATE_INEQ_CHANGE" />
                <FieldInput type="number" label="Hydrogen Flow Rate" unit="sccm" step={defaultPrecision} id="hydrogen-flow-rate"
                ...
                <FieldInput type="number" label="Carbon Source Flow Rate" unit="sccm" step={defaultPrecision} id="carbon-source-flow-rate"
                  valueType="CARBON_SOURCE_FLOW_RATE_CHANGE" ineqType="CARBON_SOURCE_FLOW_RATE_INEQ_CHANGE" />
                <FieldInput type="number" label="Argon Flow Rate" unit="sccm" step={defaultPrecision} id="argon-flow-rate"
                  valueType="ARGON_FLOW_RATE_CHANGE" ineqType="ARGON_FLOW_RATE_INEQ_CHANGE" />
                <FieldInput type="number" label="Cooling Rate" unit="&deg;C/min" step={defaultPrecision} id="cooling-rate"
          ...
          <form className="w-full flex flex-col mt-10" onSubmit={e => onAddPropertiesFilters(e)}>
            ...
            {showProperties &&
              <React.Fragment>
                <FieldInput type="number" label="Growth Coverage" unit="%" step={defaultPrecision} id="growth-coverage"
                  valueType="GROWTH_COVERAGE_CHAGNE" ineqType="GROWTH_COVERAGE_INEQ_CHANGE" />
                <FieldInput type="select" label="Shape" options={shapeOptions} id="shape"
                  valueType="SHAPE_CHANGE" />
                <FieldInput type="number" label="Average Thickness of Growth" unit="nm" step={defaultPrecision} id="average-thicknes-of-growth"
                  valueType="AVERAGE_THICKNESS_OF_GROWTH_CHANGE" ineqType="AVERAGE_THICKNESS_OF_GROWTH_INEQ_CHANGE" />
                <FieldInput type="number" label="Std. Dev. of Growth" unit="nm" step={defaultPrecision} id="std-dev-of-growth"
                  valueType="STD_DEV_OF_GROWTH_CHANGE" ineqType="STD_DEV_OF_GROWTH_INEQ_CHANGE" />
                <FieldInput type="number" label="Number of Layers" unit="" step={1} id="number-of-layers"
                  valueType="NUMBER_OF_LAYERS_CHANGE" ineqType="NUMBER_OF_LAYERS_INEQ_CHANGE" />
                <FieldInput type="number" label="Domain Size" unit="um&sup2;" step={defaultPrecision} id="domain-size"
          ...
          <form className="w-full flex flex-col mt-10" onSubmit={e => onAddProvenanceInformationFilters(e)}>
            ...
            {showProvenanceInformation &&
              <React.Fragment>
                <FieldInput type="select" label="Last Name" options={lastnames} id="lastname"
                  valueType="LASTNAME_CHANGE" />
                <FieldInput type="select" label="First Name" options={firstnames} id="firstname"
                  valueType="FIRSTNAME_CHANGE" />
                <FieldInput type="select" label="Institution" options={institutions} id="institution"
