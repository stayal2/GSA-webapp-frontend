  ...
  if (type === 'number') {
    return (
      <div className='md:flex md:items-center mb-6'>
        ...
        <div className='md:w-2/3'>
          <div className='inline-block relative md:w-1/4'>
            <select
          ...
          <input
            className='bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500 md:w-1/2'
    ...
    return (
      <div className='md:flex md:items-center mb-6'>
        ...
        <div className='md:w-2/3'>
          <div className='inline-block relative md:w-3/4'>
            <select
              className='block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline'
